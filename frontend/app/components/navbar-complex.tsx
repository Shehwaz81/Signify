...
const navLinks = [
  ...
  { name: 'Real-Time Sign', href: '/real-time-sign' },
];
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-8 lg:px-10 flex justify-between items-center h-16">
        ...
        <div className="hidden md:flex items-center space-x-8">
          {navLinks.map(link => {
            ...
            const special = link.name === 'Emotion AI' || link.name === 'Sign Language' || link.name === 'Real-Time Sign';
            return (
              <Link
                key={link.name}
                href={link.href}
        ...
        {open && (
          ...
          >
                ...
                >
                  <Link
                    ...
                    className={`text-xl font-semibold transition-colors duration-300 ${
                      link.name === 'Emotion AI' || link.name === 'Sign Language' || link.name === 'Real-Time Sign'
            ...
            <div className="mt-auto flex justify-center">
              ...
              >
                {theme === 'dark' ? <SunIcon className="h-5 w-5 text-yellow-300" /> : <MoonIcon className="h-5 w-5 text-white" />}
